...
import { 
  ...
  getAssignedLeadsMobileInfo,
  getAssignedLeadsEmailInfo,
  createAssignedLead,
  updateAssignedLead,
...
router.get('/get-assigned-leads-mobile-info', getAssignedLeadsMobileInfo);
router.get('/get-assigned-leads-email-info', getAssignedLeadsEmailInfo);
